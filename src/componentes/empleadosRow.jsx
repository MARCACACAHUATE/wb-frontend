...
const EmpleadosRow = ({empleado}) => {
  ...
  return (
    ...
    <td className="rowactions">
        <button onClick={()=>modifyEvento(empleado)} type="button" className="btn btn-info">
        <svg
        ...
        <button onClick={()=>deleteEvento(empleado.id)} type="button" className="btn btn-danger">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
    ...
    <td className="adminrow">{empleado.id}</td>
      ...
      <td className="adminrow">{empleado.telefono}</td>

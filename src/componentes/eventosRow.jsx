...
const EventosRow = ({evento,rol}) => {
  ...
  return (
    ...
    <td className="rowactions">
        <button onClick={()=>modifyEvento(evento)} type="button" className="btn btn-info">
        <svg
    ...
    <td className="adminrow">{evento.nombrePaquete}</td>
    <td className="adminrow">{evento.ocasion}</td>
